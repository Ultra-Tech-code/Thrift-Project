...
contract Jointthrift {
    ...
    function createGoal(address _owner, string memory _goalDescription, uint256 _target, uint256 _duration, IERC20 _currency, uint256 _startTime, uint256 members, address[] memory membersAddress) external returns(uint256 thriftID) {
